...
| 日期 | 组 | 槽位 | 一句话 |
|---|---|---|---|
| 2026-08-13 | [从平铺线索到可行走的真相地形](../../project/evidence/v3-design/2026-08-13-object-truth-topology-portfolio-process-asset.md) | concept | V3 立项时的核心转向:线索列表变成可行走的地形 |
| 2026-08-24 | [玩家知识地图的三个地标模型](../2026-08-24-knowledge-map-landmark-models/README.md) | process | 同一份作者真相的三种组织方式,两种被渲染证据否决 |
...
这些都**不是**最终作品集页面。它们是过程资产,作用是支撑"问题—演化—机制—结果"式的少量页面,不是堆成开发日志。
研究图、Ron Gilbert 原图、开发中间切片不得直接进最终 PDF。
来源与公开使用限制见 [V3 证据包](../../project/evidence/v3-design/README.md)。

采集用的本机静态服务已关闭,不是常驻进程;需要重新导出时临时起一个即可。
