...
当前只讨论[一页局部逻辑候选](evidence/v3-design/2026-09-07-xray-photo-local-logic-candidate.md)，还没有修改游戏规则或制作新整图。融合版与此前页面作为可恢复的对照保存，机器证据保留，不能标成玩家体验通过。高保真方向继续保留，先解决局部可理解性再扩展。
