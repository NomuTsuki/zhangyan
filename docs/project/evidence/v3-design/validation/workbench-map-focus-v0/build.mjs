/* Build a standalone, double-clickable HTML for the question-focus experiment.
   Rules remain sourced from the frozen author model. Layout/session/projection
   are byte-identical snapshots from workbench-map-layout-v1 so this entry
   changes only the player-facing focus layer. Run with: node build.mjs */
