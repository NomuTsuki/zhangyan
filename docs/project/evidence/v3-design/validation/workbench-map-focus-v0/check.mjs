...
import { SLOT_FACTS, decisionSurface, mentalMap } from "./projection.mjs";
...
assert(corpusRelated.has("F:latent.current-craft"), "a directly connected Finding is related");
...
console.log("PASS focus model: 22 actions, five questions, four Q5 facets, action/place/map/decision focus");
