...
这是一套可直接解压到新仓库根目录的项目启动资料，不包含具体框架代码。
...
4. 当前不要直接开发完整游戏，先完成低保真 UI 原型。
5. 低保真原型经老师确认后，再进入 Sprint 1 灰盒开发。
...
| `docs/06_UI_LOFI_TASK.md` | 当前低保真 UI 任务书 |
...
制作“民国漆木首饰盒”低保真竖屏可点击原型，打通观察、证据、询问、对质、交易和复盘。
